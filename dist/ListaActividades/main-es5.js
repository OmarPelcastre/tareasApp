...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony default export */ __webpack_exports__["default"] = ("<h2>Cambio desde local con integración continua ngrok<h2>\n<router-outlet></router-outlet>  \n\n\n\n");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("<!-- <form #activityForm=\"ngForm\" (ngSubmit)=\"onSubmit()\" class=\"col-lg-12\">\n    <p>\n        <label>Nombre</label>\n        <input type=\"text\" name=\"name\" #name=\"ngModel\" [(ngModel)]=\"activity.activity\" class=\"form-control\" required>\n\n    </p>\n\n    <div class=\"dropdown\">\n        <button class=\"btn btn-secondary dropdown-toggle\" type=\"button\" id=\"dropdownMenuButton\" data-toggle=\"dropdown\"\n            aria-haspopup=\"true\" aria-expanded=\"false\">\n            Dia\n        </button>\n        <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" *ngIf=\"dias\">\n            <p class=\"dropdown-item\" *ngFor=\"let dia of dias\" (click)=\"setDia(dia)\">\n                {{dia}}\n            </p>\n        </div>\n    </div>\n    <br>\n\n    <div class=\"dropdown\">\n        <button class=\"btn btn-secondary dropdown-toggle\" type=\"button\" id=\"dropdownMenuButton\" data-toggle=\"dropdown\"\n            aria-haspopup=\"true\" aria-expanded=\"false\">\n            Mes\n        </button>\n        <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" *ngIf=\"meses\">\n            <p class=\"dropdown-item\" *ngFor=\"let mes of meses\" (click)=\"setMes(mes)\">\n                {{mes}}\n            </p>\n        </div>\n    </div>\n    <br>\n    <div class=\"dropdown\">\n        <button class=\"btn btn-secondary dropdown-toggle\" type=\"button\" id=\"dropdownMenuButton\" data-toggle=\"dropdown\"\n            aria-haspopup=\"true\" aria-expanded=\"false\">\n            Hora\n        </button>\n        <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" *ngIf=\"horas\">\n            <p class=\"dropdown-item\" *ngFor=\"let hora of horas\" (click)=\"setHora(hora)\">\n                {{hora}}\n            </p>\n        </div>\n    </div>\n\n\n    <div [formGroup]=\"myTareas\">\n        <label>Tareas</label>\n        <div formArrayName=\"tareasArray\" [formGroupName]=\"pointIndex\">\n            <div *ngFor=\"let terea of tareas; let pointIndex=index\">\n                <input type=\"text\" formControlName=\"tarea\" name=\"pointIndex\">\n            </div>\n        </div>\n\n        <button class=\"btn btn-secondary\" (click)=\"addTarea()\">Agregar otra tarea</button>\n    </div>\n\n\n\n    <input type=\"submit\" value=\"Crear\" class=\"btn btn-success\" [disabled]=\"!activityForm.form.valid\">\n\n\n</form> -->\n\n\n<form [formGroup]=\"miFormulario\" (submit)=\"onSubmit(miFormulario.value)\">\n    <div class=\"form-group\">\n        <label for=\"nombre\">Nombre de la Actividad</label>\n        <input type=\"text\" class=\"form-control\" formControlName=\"nombre\" placeholder=\"Nombre de la actividad\">\n    </div>\n\n    <div class=\"dropdown\">\n        <button class=\"btn btn-secondary dropdown-toggle\" type=\"button\" id=\"dropdownMenuButton\" data-toggle=\"dropdown\"\n            aria-haspopup=\"true\" aria-expanded=\"false\">\n            Dia\n        </button>\n        <span>    {{dia}}</span>\n        <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" *ngIf=\"dias\">\n            <p class=\"dropdown-item\" *ngFor=\"let dia of dias\" (click)=\"setDia(dia)\">\n                {{dia}}\n            </p>\n        </div>\n    </div>\n    <br>\n\n    <div class=\"dropdown\">\n        <button class=\"btn btn-secondary dropdown-toggle\" type=\"button\" id=\"dropdownMenuButton\" data-toggle=\"dropdown\"\n            aria-haspopup=\"true\" aria-expanded=\"false\">\n            Mes\n        </button>\n        <span>    {{mes}}</span>\n        <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" *ngIf=\"meses\">\n            <p class=\"dropdown-item\" *ngFor=\"let mes of meses\" (click)=\"setMes(mes)\">\n                {{mes}}\n            </p>\n        </div>\n    </div>\n    <br>\n    <div class=\"dropdown\">\n        <button class=\"btn btn-secondary dropdown-toggle\" type=\"button\" id=\"dropdownMenuButton\" data-toggle=\"dropdown\"\n            aria-haspopup=\"true\" aria-expanded=\"false\">\n            Hora\n        </button>\n        <span>    {{hora}}</span>\n        <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" *ngIf=\"horas\">\n            <p class=\"dropdown-item\" *ngFor=\"let hora of horas\" (click)=\"setHora(hora)\">\n                {{hora}}\n            </p>\n        </div>\n    </div>\n\n    <br>\n    <h3>Tareas </h3>\n    <br>\n    <div class=\"form-group\">\n        <div formArrayName=\"telefonos\">\n            <div *ngFor=\"let item of getTelefonos.controls; let pointIndex=index\" [formGroupName]=\"pointIndex\">\n                <input formControlName=\"tarea\"  class=\"form-control\"/>\n                <a class=\"btn btn-link\" (click)=\"removeTelefono(pointIndex)\">eliminar</a>\n            </div>\n        </div>\n        <a class=\"btn btn-link\" (click)=\"addTelefono()\">Agregar otra tarea</a>\n    </div>\n    <button type=\"submit\" class=\"btn btn-primary\">Crear Actividad</button>\n\n</form>");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("<button type=\"button\" class=\"btn btn-primary btn-lg\" [routerLink]=\"['/create']\">Agregar Actividad</button>\n<div class=\"accordion\" id=\"accordionExample\" *ngIf=\"activities\">\n  <div class=\"card\" *ngFor=\"let activity of activities\">\n    <div class=\"card-header\" id=\"headingOne\">\n      <h2 class=\"mb-0\">\n        <button class=\"btn btn-link\" type=\"button\" data-toggle=\"collapse\" data-target=\"#collapseOne\"\n          aria-expanded=\"true\" aria-controls=\"collapseOne\">\n          {{activity.activity}} {{activity.dia}} de {{activity.mes}} {{activity.hora}}\n        </button>\n        <button class=\"btn btn-danger\" (click)=\"delete(activity.id)\">eliminar</button>\n      </h2>\n    </div>\n\n    <div id=\"collapseOne\" class=\"collapse show\" aria-labelledby=\"headingOne\" data-parent=\"#accordionExample\"\n    *ngFor=\"let tarea of activity.tareas\">\n      <div class=\"card-body\" (click)=\"imprimir()\">\n       {{activity.tareas.indexOf(tarea)+1}}.- {{tarea.tarea}}\n      </div>\n    </div>\n  </div>\n</div>");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateComponent = /** @class */ (function () {
                function CreateComponent(fb, firestoreService, router) {
                    this.fb = fb;
                    this.firestoreService = firestoreService;
                    this.router = router;
                    this.dias = [];
                ...
                CreateComponent.prototype.onSubmit = function (formValue) {
                    var _this = this;
                    this.activity = {
                    ...
                    this.firestoreService.createActivity(this.activity).then(function (res) {
                        console.log(res);
                        _this.router.navigate(['/home']);
                    });
                };
                Object.defineProperty(CreateComponent.prototype, "getTelefonos", {
                    get: function () {
                        return this.miFormulario.get('telefonos');
                    },
                    enumerable: true,
                    configurable: true
                });
                CreateComponent.prototype.addTelefono = function () {
                    var control = this.miFormulario.controls['telefonos'];
                    control.push(this.fb.group({ tarea: [] }));
                };
                CreateComponent.prototype.removeTelefono = function (index) {
                    var control = this.miFormulario.controls['telefonos'];
                    control.removeAt(index);
                };
                CreateComponent.prototype.addTarea = function () {
                    this.tareas.push("");
                };
                CreateComponent.prototype.initDias = function () {
                    for (var index = 1; index < 32; index++) {
                        this.dias.push(String(index));
                    }
                };
                CreateComponent.prototype.initMeses = function () {
                    this.meses = [
                        'Enero',
                        'Febrero',
                        'Marzo',
                ...
                CreateComponent.prototype.initHoras = function () {
                ...
                CreateComponent.prototype.setDia = function (dia) {
                    console.log(dia);
                    this.dia = dia;
                };
                CreateComponent.prototype.setMes = function (mes) {
                    this.mes = mes;
                };
                CreateComponent.prototype.setHora = function (hora) {
                    this.hora = hora;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(firestoreService) {
                    this.firestoreService = firestoreService;
                    this.title = 'ListaActividades';
                }
                ...
                HomeComponent.prototype.getActivities = function () {
                    var _this = this;
                    this.firestoreService.getActivities().subscribe(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = this;
                                    return [4 /*yield*/, data.map(function (e) {
                ...
                HomeComponent.prototype.imprimir = function () {
                    console.log(this.activities);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FirestoreService = /** @class */ (function () {
                ...
                FirestoreService.prototype.createActivity = function (data) {
                    return this.firestore.collection('activities').add(data);
                };
                FirestoreService.prototype.getActivity = function (documentId) {
                    return this.firestore.collection('activities').doc(documentId).snapshotChanges();
                };
                FirestoreService.prototype.getActivities = function () {
                    return this.firestore.collection('activities').snapshotChanges();
                };
                FirestoreService.prototype.updateActivity = function (documentId, data) {
                    return this.firestore.collection('activities').doc(documentId).set(data);
                };
                FirestoreService.prototype.deleteActivity = function (documentId) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var environment = {
                production: false,
                firebaseConfig: {
                    apiKey: "AIzaSyD5aahXbZytSQO52cOC-PiPGMd0AsARPsk",
                    authDomain: "listaactividades-d8238.firebaseapp.com",
                    databaseURL: "https://listaactividades-d8238.firebaseio.com",
                    projectId: "listaactividades-d8238",
                    storageBucket: "listaactividades-d8238.appspot.com",
                    messagingSenderId: "284812217156",
                    appId: "1:284812217156:web:0a221549c2857784766511"
                }
            };
            /*
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! /Users/omarpelcastre/Desktop/Proyectos/ListaActividades/src/main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
