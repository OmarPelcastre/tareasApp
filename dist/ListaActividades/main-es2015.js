...
let CreateComponent = class CreateComponent {
    constructor(fb, firestoreService, router) {
        this.fb = fb;
        this.firestoreService = firestoreService;
        this.router = router;
        this.dias = [];
    ...
    addTelefono() {
        const control = this.miFormulario.controls['telefonos'];
...
let HomeComponent = class HomeComponent {
    ...
    getActivities() {
        this.firestoreService.getActivities().subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.activities = yield data.map(e => {
...
let FirestoreService = class FirestoreService {
    ...
    updateActivity(documentId, data) {
